...
class luaran_pkm_mahasiswa_sarjana_json extends CI_Controller {
	...
	function json()
	{
		...
		$this->load->model("base/LuaranPkmMahasiswa");

		$set= new LuaranPkmMahasiswa();
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				else if ($valkey == "luaran")
				{
					$val="'app/loadurl/main/lihat_pdf_lengkap?dosen_id=".$set->getField('luaran_penelitian_mahasiswa_id')."&table_field=".strtolower($valkey)."'";
