...
class MasaStudyS1 extends Entity{ 

	var $query;

	function MasaStudyS1()
	{
		$this->Entity(); 
	}
	...
	function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='')
	{
		...
		SELECT
			*,
			 ROW_NUMBER () OVER (ORDER BY lulusan_prodi_s1_id) as NO
		FROM lulusan_prodi_s1 A
		WHERE 1=1 "; 
		...
		$str .= $statement." ORDER BY lulusan_prodi_s1_id ASC";
		$this->query = $str;
		// echo $statement;exit;
