...
class ProfilDosenLatarBelakangKeahlian extends Entity{ 

	var $query;

	function ProfilDosenLatarBelakangKeahlian()
	{
		$this->Entity(); 
	}
	...
	function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='')
	{
		...
		SELECT
			*
			,ROW_NUMBER () OVER (ORDER BY Profil_Dosen_Latar_Belakang_Keahlian_id ASC) as NO
		FROM Profil_Dosen_Latar_Belakang_Keahlian A
		WHERE 1=1 "; 
		...
		$str .= $statement." ORDER BY Profil_Dosen_Latar_Belakang_Keahlian_id ASC";
		$this->query = $str;
		// echo $statement;exit;
