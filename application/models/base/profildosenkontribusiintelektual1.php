...
class ProfilDosenKontribusiIntelektual1 extends Entity{ 

	var $query;

	function ProfilDosenKontribusiIntelektual1()
	{
		$this->Entity(); 
	}
	...
	function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='')
	{
		...
		SELECT
			*
			,ROW_NUMBER () OVER (ORDER BY profil_dosen_kontribusi_intelektual_1_id ASC) as NO
		FROM profil_dosen_kontribusi_intelektual_1 A
		WHERE 1=1 "; 
		...
		$str .= $statement." ORDER BY profil_dosen_kontribusi_intelektual_1_id ASC";
		$this->query = $str;
		// echo $statement;exit;
