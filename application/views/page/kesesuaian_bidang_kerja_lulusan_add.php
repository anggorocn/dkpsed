...
if(!empty($reqId))
{
	...
	$set->selectByParams(array('kesesuaian_bidang_kerja_lulusan_id'=>$reqId));
	// echo $set->query;exit;
	$set->firstRow();
	$reqTahun= $set->getField('tahun');
	$reqJumlahDiterima= $set->getField('jumlah');
	$reqJumlahTerlacak= $set->getField('jumlah_terlacak');
	$reqTidakSesuai= $set->getField('sesuai');
	$reqSesuai= $set->getField('tidak_sesuai');
        ...
        <form class="form" id="ktloginform" method="POST" enctype="multipart/form-data">
	        <div class="card card-custom">
	        	...
	        	<div class="card-body">
	        		...
	        		<div class="form-group row">
	        			<label class="col-form-label col-lg-2 col-sm-12">Jumlah Lulusan Terlacak dengan Tingkat Kesesuaian Bidang Kerja</label>	
	        			<div class="col-lg-8 col-sm-12">
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">Tidak Sesuai</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqTidakSesuai" class="form-control" value="<?=$reqTidakSesuai?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">Sesuai</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqSesuai" class="form-control" value="<?=$reqSesuai?>">
			        			</div>
			        		</div>
	        			</div>
	        		</div>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/kesesuaian_bidang_kerja_lulusan_json/add";
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "app/page/kesesuaian_bidang_kerja_lulusan?reqId=<?=$reqPageBack?>";
			        	});
			        },
