...
$arrtabledata= array(
    ...
    , array("label"=>"Jumlah", "field"=> "jumlah", "display"=>"",  "width"=>"10px")
                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr> 
                            ...
                            {   
                                if($valitem["field"]=='NO' ||$valitem["field"]=='nama' || $valitem["field"] =='jumlah' || $valitem["field"] =='standar'){
                                    echo "<th rowspan=2>".$valitem["label"]."</th>";
                                }
                                else if( $valitem["field"]=='ts_2'){
                                    echo "<th colspan=3 style='text-align:center'>Jumlah Judul</th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr> 
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"] =='ts_2'||$valitem["field"] =='ts_1'||$valitem["field"] =='ts'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/publikasi_ilmiah_mahasiswa_json/json?reqTipe=TERAPAN";
