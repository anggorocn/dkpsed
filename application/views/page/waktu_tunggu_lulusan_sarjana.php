...
$arrtabledata= array(
    ...
    , array("label"=>"Jumlah Lulusan yang Terlacak", "field"=> "ts_6", "display"=>"",  "width"=>"10px")
    , array("label"=>"Jumlah Lulusan yang Dipesan Sebelum Lulus", "field"=> "ts_5", "display"=>"",  "width"=>"10px")
    , array("label"=>"WT < 3 bulan", "field"=> "ts_4", "display"=>"",  "width"=>"10px")
    , array("label"=>"3 ≤ WT ≤ 6 bulan", "field"=> "ts_3", "display"=>"",  "width"=>"10px")
    , array("label"=>"WT > 6 bulan", "field"=> "ts_2", "display"=>"",  "width"=>"10px")
    , array("label"=>"Standar Pendidikan Tinggi yang ditetapkan oleh Perguruan Tinggi", "field"=> "ts_1", "display"=>"",  "width"=>"10px")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/waktu_tunggu_lulusan_sarjana_json/json";
