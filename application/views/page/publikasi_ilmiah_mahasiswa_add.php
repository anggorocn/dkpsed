	        ...
	        <div class="card card-custom">
	        	...
	        	<div class="card-body">
	        		<div class="form-group row">
	        			<label class="col-form-label col-lg-2 col-sm-12">Media Publikasi</label>	
    		...
    		<div class="card-footer">
        		<div class="row">
        			<div class="col-lg-9">
        				...
        				<input type="hidden" name="reqGolongan" value="UMUM">
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "app/page/publikasi_ilmiah_mahasiswa?reqId=<?=$reqPageBack?>";
			        	});
			        },
