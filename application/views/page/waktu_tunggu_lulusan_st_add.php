...
if(!empty($reqId))
{
	...
	$reqWaktu31= $set->getField('waktu3_1');
	$reqWaktu32= $set->getField('waktu3_2');
	$reqWaktu33= $set->getField('waktu3_3');
	        ...
	        <div class="card card-custom">
	        	<div class="card-header">
	                <div class="card-title">
	                    ...
	                    <h3 class="card-label">Tabel 13. Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan)</h3>
	                </div>
	        			...
	        			<div class="col-lg-8 col-sm-12">
			        		<div class="form-group row">
			        			...
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu31" class="form-control" value="<?=$reqWaktu31?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">3 ≤ WT ≤ 6 bulan</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu32" class="form-control" value="<?=$reqWaktu32?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">WT > 6 bulan</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu33" class="form-control" value="<?=$reqWaktu33?>">
			        			</div>
			        		</div>
			        	</div>
			        </div>
    		...
    		<div class="card-footer">
        		<div class="row">
        			<div class="col-lg-9">
        				...
        				<input type="hidden" name="reqJenjang" value="st">
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "app/page/waktu_tunggu_lulusan_st?reqId=<?=$reqPageBack?>";
			        	});
			        },
...
</script>waktu_tunggu_lulusan_stwaktu_tunggu_lulusan_st