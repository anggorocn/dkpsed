...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Mahasiwa", "field"=> "jenis", "display"=>"",  "width"=>"", "nowrap"=>"1")
    , array("label"=>"Nama Produk/Jasa", "field"=> "nilai_a", "display"=>"",  "width"=>"10px")
    , array("label"=>"Deskripsi Produk/Jasa", "field"=> "nilai_b", "display"=>"",  "width"=>"10px")
    , array("label"=>"Bukti", "field"=> "nilai_c", "display"=>"",  "width"=>"10px")
    , array("label"=>"Standar Pendidikan Tinggi yang ditetapkan oleh Perguruan Tinggi", "field"=> "nilai_d", "display"=>"",  "width"=>"10px")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 21. Produk/Jasa yang Dihasilkan Mahasiswa yang Diadopsi Oleh Industri/Masyarakat (Khusus Program Diploma Tiga/Sarjana Terapan/Magister Terapan/Doktor Terapan)                 </h3>
                </div>
