...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Mahasiwa", "field"=> "nama", "display"=>"",  "width"=>"", "nowrap"=>"1")
    , array("label"=>"Nama Produk/Jasa", "field"=> "Judul", "display"=>"",  "width"=>"10px")
    , array("label"=>"Deskripsi Produk/Jasa", "field"=> "Deskripsi", "display"=>"",  "width"=>"10px")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/karya_ilmiah_mahasiswa_disitasi_magister_json/json?reqTipe=TERAPAN";
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/page/produk_hasil_mahasiswa_diadopsi_industri_add?reqId=<?=$reqId?>&reqRowId="+vpilihid;
