...
$arrtabledata= array(
    ...
    , array("label"=>"Nama Kegiatan", "field"=> "nama", "display"=>"",  "width"=>"")
    , array("label"=>"Akademik/Non-Akademik", "field"=> "jenis", "display"=>"",  "width"=>"", "nowrap"=>"1")
    , array("label"=>"Tahun Perolehan", "field"=> "tahun", "display"=>"",  "width"=>"15%")
    , array("label"=>"Tingkat", "field"=> "tingkat", "display"=>"",  "width"=>"15%")
    , array("label"=>"Prestasi yang Dicapai", "field"=> "juara", "display"=>"",  "width"=>"15%")
    , array("label"=>"Standar Pendidikan Tinggi yang ditetapkan oleh Perguruan Tinggi", "field"=> "standart", "display"=>"",  "width"=>"15%")
    ...
    , array("label"=>"fieldid", "field"=> "prestasi_id", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 7. Prestasi Akademik dan Non-Akademik Mahasiswa</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/prestasi_mahasiswa_json/json";
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/prestasi_mahasiswa_add?reqId=<?=$reqId?>";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/page/prestasi_mahasiswa_add?reqId=<?=$reqId?>&reqRowId="+vpilihid;
