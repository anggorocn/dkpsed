        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 11. Masa Studi Lulusan Program Studi (Khusus Program Doktor dan Doktor Terapan)</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/masa_studi_lulusan_doktor_json/json";
