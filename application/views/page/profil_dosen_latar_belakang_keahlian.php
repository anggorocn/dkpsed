...
$arrtabledata= array(
    ...
    , array("label"=>"Doktor/Doktor Terapan/ Spesialis", "field"=> "PENDIDIKAN_DOKTOR", "display"=>"",  "width"=>"10px")
    , array("label"=>"Bidang Keahlian", "field"=> "KEAHLIAN", "display"=>"",  "width"=>"10px")
                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            ...
                            {
                                if($valitem["field"]!='PENDIDIKAN_MAGISTER' && $valitem["field"]!='PENDIDIKAN_DOKTOR'){
