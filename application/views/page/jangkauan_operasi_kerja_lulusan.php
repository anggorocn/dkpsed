...
$arrtabledata= array(
    ...
    , array("label"=>"Lokal/Wilayah/ Berwirausaha tidak Berizin", "field"=> "lokal", "display"=>"",  "width"=>"10px")
    , array("label"=>"Nasional/ Berwirausaha Berizin", "field"=> "nasional", "display"=>"",  "width"=>"10px")
    , array("label"=>"Multinasional/ Internasional", "field"=> "internasional", "display"=>"",  "width"=>"10px")
    ...
    , array("label"=>"fieldid", "field"=> "jangkauan_operasi_wilayah_lulusan_id", "display"=>"1", "width"=>"")
);
?>
                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr> 
                            ...
                            {   
                                if($valitem["field"]=='NO' ||$valitem["field"]=='tahun' || $valitem["field"] =='jumlah' || $valitem["field"] =='jumlah_terlacak' || $valitem["field"] =='keterangan'){
                                    echo "<th rowspan=2>".$valitem["label"]."</th>";
                                }
                                else if( $valitem["field"]=='lokal'){
                                    echo "<th colspan=3 style='text-align:center'>Jumlah Lulusan Terlacak yang Bekerja berdasarkan Tingkat/Ukuran Tempat Kerja/Berwirausaha</th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr> 
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"] =='lokal'||$valitem["field"] =='nasional'||$valitem["field"] =='internasional'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/jangkauan_operasi_kerja_lulusan_json/json";
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/page/jangkauan_operasi_kerja_lulusan_add?reqId=<?=$reqId?>&reqRowId="+vpilihid;
