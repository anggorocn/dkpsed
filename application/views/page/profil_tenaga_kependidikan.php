                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            ...
                            {
                                if($valitem["field"]=='NAMA' || $valitem["field"]=='NO' || $valitem["field"]=='status' || $valitem["field"]=='JABATAN_AKADEMIK' || $valitem["field"]=='sertifikat_lain'){
                                    echo "<th rowspan='2'>".$valitem["label"]."</th>";
                                }
                                else if($valitem["field"]=='pendidikan_diploma'){
                                    echo "<th colspan=4 style='text-align:center'>Pendidikan yang Telah Ditempuh</th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"]=='pendidikan_diploma' || $valitem["field"]=='pendidikan_sarjana' || $valitem["field"]=='PENDIDIKAN_MAGISTER' || $valitem["field"]=='PENDIDIKAN_SPESIALIS'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/profil_tenaga_kependidikan_json/json";
