...
$arrtabledata= array(
    ...
    , array("label"=>"WT < 3 bulan", "field"=> "waktu1_1", "display"=>"",  "width"=>"10px")
    , array("label"=>"3 ≤ WT ≤ 6 bulan", "field"=> "waktu1_2", "display"=>"",  "width"=>"10px")
    , array("label"=>"WT > 6 bulan", "field"=> "waktu1_3", "display"=>"",  "width"=>"10px")
                    ...
                    <thead>
                        <tr> 
                            ...
                            {   
                                ...
                                else if( $valitem["field"]=='waktu1_1'){
                        ...
                        <tr> 
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"] =='waktu1_1'||$valitem["field"] =='waktu1_2'||$valitem["field"] =='waktu1_3'){
...
jQuery(document).ready(function() {
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/page/waktu_tunggu_lulusan_d3_add?reqId=<?=$reqId?>&reqRowId="+vpilihid;
