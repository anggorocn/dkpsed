...
$arrtabledata= array(
    ...
    , array("label"=>"Tidak Sesuai", "field"=> "tidak_sesuai", "display"=>"",  "width"=>"10px")
    , array("label"=>"Sesuai", "field"=> "sesuai", "display"=>"",  "width"=>"10px")
                    ...
                    <thead>
                        <tr> 
                            ...
                            {   
                                ...
                                else if( $valitem["field"]=='tidak_sesuai'){
                                    echo "<th colspan=2 style='text-align:center'>Jumlah Lulusan Terlacak dengan Tingkat Kesesuaian Bidang Kerja</th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr> 
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"] =='tidak_sesuai'||$valitem["field"] =='sesuai'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/kesesuaian_bidang_kerja_lulusan_json/json";
