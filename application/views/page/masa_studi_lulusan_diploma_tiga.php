        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 8. Masa Studi Lulusan Program Studi (Khusus Program Diploma Tiga)</h3>
                </div>
                    ...
                    <thead>
                        <tr> 
                            ...
                            {   
                                ...
                                else if( $valitem["field"]=='ts_4'){
                                    echo "<th colspan=5 style='text-align:center'>Jumlah Mahasiswa yang Lulus pada          </th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr> 
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"]=='ts_4' || $valitem["field"] =='ts_3'|| $valitem["field"] =='ts_2'|| $valitem["field"] =='ts_1'|| $valitem["field"] =='ts'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/masa_studi_lulusan_json/json?reqTingkatan=d3";
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/page/masa_studi_lulusan_diploma_tiga_add?reqId=<?=$reqId?>&reqRowId="+vpilihid;
