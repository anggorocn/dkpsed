...
$arrtabledata= array(
    ...
    , array("label"=>"PS yang Diakreditasi", "field"=> "ps_diakreditasi", "display"=>"",  "width"=>"")
    , array("label"=>"PS Lain di dalam PT", "field"=> "ps_lain_dalam", "display"=>"",  "width"=>"")
    , array("label"=>"PS Lain di luar PT", "field"=> "ps_lain_luar", "display"=>"",  "width"=>"")
    , array("label"=>"Penelitian", "field"=> "penelitian", "display"=>"",  "width"=>"")
    , array("label"=>"PkM", "field"=> "pkm", "display"=>"",  "width"=>"")
    , array("label"=>"Tugas Tambahan dan/atau Penunjang", "field"=> "penunjang", "display"=>"",  "width"=>"")
    , array("label"=>"Jumlah (sks)", "field"=> "sks", "display"=>"",  "width"=>"")
    , array("label"=>"Rata-rata per Semester (sks)", "field"=> "avg_sks", "display"=>"",  "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 4 Ekuivalen Waktu Mengajar Penuh (EWMP) </h3>
                </div>
                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            ...
                            {
                                if($valitem["field"]=='NAMA'||$valitem["field"]=='NO'||$valitem["field"]=='sks'||$valitem["field"]=='avg_sks'){
                                    echo "<th rowspan='3'>".$valitem["label"]."</th>";
                                }
                                else if($valitem["field"]=='ps_diakreditasi'){
                                    echo "<th colspan=6 style='text-align:center'>Ekuivalen Waktu Mengajar Penuh (EWMP) pada saat TS dalam satuan kredit semester (sks)</th>";
                                }
                            }
                            ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"]=='ps_diakreditasi'){
                                    echo "<th colspan=3 style='text-align:center'>Pendidikan: Pembelajaran dan Pembimbingan</th>";
                                }
                                else if($valitem["field"]!='NAMA' && $valitem["field"]!='NO' && $valitem["field"]!='sks' && $valitem["field"]!='avg_sks' && $valitem["field"]!='ps_lain_dalam' && $valitem["field"]!='ps_lain_luar'){
                        ...
                        <tr>
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"]=='ps_diakreditasi' || $valitem["field"]=='ps_lain_dalam' || $valitem["field"]=='ps_lain_luar'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/ekuivalen_waktu_mengajar_penuh_json/json";
