...
$arrtabledata= array(
    ...
    , array("label"=>"Praktik dan Profesional", "field"=> "praktik_professional", "display"=>"",  "width"=>"")
    , array("label"=>"Penelitian ", "field"=> "penelitian", "display"=>"",  "width"=>"")
    , array("label"=>"Google Scholar", "field"=> "link", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "profil_dosen_kontribusi_intelektual_1_id", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 3b. Profil Dosen Berdasarkan Kontribusi Intelektual </h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/profil_dosen_kontribusi_intelektual_2_json/json";
