	        ...
	        <div class="card card-custom">
	        	<div class="card-header">
	                <div class="card-title">
	                    ...
	                    <h3 class="card-label">Tabel 10. Masa Studi Lulusan Program Studi (Program Magister dan Magister Terapan)</h3>
	                </div>
	        			...
	        			<div class="col-lg-8 col-sm-12">
			        		<div class="form-group row">
			        			...
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqTs6" class="form-control" value="<?=$reqTs6?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">TS-5</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqTs5" class="form-control" value="<?=$reqTs5?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "app/page/masa_studi_lulusan_doktor?reqId=<?=$reqPageBack?>";
			        	});
			        },
