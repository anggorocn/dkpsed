...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "profil_dosen_status_kepegawaian_id", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Tabel 1 Profil Dosen Berdasarkan Status Kepegawaian </h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/profil_dosen_status_kepegawaian_json/json";
