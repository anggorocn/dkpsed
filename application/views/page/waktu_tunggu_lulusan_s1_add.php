...
if(!empty($reqId))
{
	...
	$reqWaktu21= $set->getField('waktu2_1');
	$reqWaktu22= $set->getField('waktu2_2');
	$reqWaktu23= $set->getField('waktu2_3');
	        			...
	        			<div class="col-lg-8 col-sm-12">
			        		<div class="form-group row">
			        			...
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu21" class="form-control" value="<?=$reqWaktu21?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">6 ≤ WT ≤ 18 bulan</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu22" class="form-control" value="<?=$reqWaktu22?>">
			        			</div>
			        		</div>
			        		<div class="form-group row">
		        				<label class="col-form-label col-lg-2 col-sm-12">WT > 18 bulan</label>	
			        			<div class="col-lg-10 col-sm-12">
			        				<input type="text" name="reqWaktu23" class="form-control" value="<?=$reqWaktu23?>">
			        			</div>
			        		</div>
			        	</div>
			        </div>
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "app/page/waktu_tunggu_lulusan_s1?reqId=<?=$reqPageBack?>";
			        	});
			        },
