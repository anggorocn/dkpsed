...
$arrtabledata= array(
    ...
    , array("label"=>"Berita Acara ", "field"=> "berita_acara", "display"=>"",  "width"=>"10px")
    , array("label"=>"Skor", "field"=> "Skor", "display"=>"",  "width"=>"10px")
    , array("label"=>"sertifikat", "field"=> "sertifikat", "display"=>"",  "width"=>"10px")
    ...
    , array("label"=>"fieldid", "field"=> "penilaian_id", "display"=>"1", "width"=>"")
);
?>
                ...
                <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            ...
                            {
                                if($valitem["field"]=='NO' ||$valitem["field"]=='nama'){
                                    echo "<th rowspan=2 >".$valitem["label"]."</th>";
                                }
                                else if($valitem["field"]=='berita_acara')
                                {
                                    echo "<th colspan=3 style='text-align:center'> Nama Sheet</th>";
                                }
                            }
                            ?>
                        </tr>
                        <tr>
                            ...
                            foreach($arrtabledata as $valkey => $valitem) 
                            {
                                if($valitem["field"]=='berita_acara' ||$valitem["field"]=='Skor'||$valitem["field"]=='sertifikat'){
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/penilaian_json/json";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/penilaian_json/delete?reqRowId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/penilaian?reqId=<?=$reqId?>";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/penilaian_add?reqId="+vpilihid;
