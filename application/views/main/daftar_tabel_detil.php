...
$set= new DaftarTabel();
$set->selectByParamsField(array('a.daftar_tabel_id'=>$reqId));
// echo $set->query;exit;
while($set->nextRow()){
    array_push($arrtabledata, array("label"=>$set->getField('field_alias'), "field"=> $set->getField('field'), "display"=>"",  "width"=>""));
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"><?=$reqName?></h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/profil_dosen_json/jsonDetil";
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/profil_dosen_add?reqId="+vpilihid;
