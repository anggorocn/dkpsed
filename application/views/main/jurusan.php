...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "Jurusan_id", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/jurusan_json/json";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/jurusan_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/jurusan_add?reqId="+vpilihid;
