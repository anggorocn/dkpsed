...
$arrtabledata= array(
    ...
    , array("label"=>"Nomor dan Judul Tabel", "field"=> "NAMA", "display"=>"",  "width"=>"", "nowrap"=>"1")
    , array("label"=>"Nama Sheet", "field"=> "NAMA_SHEET", "display"=>"",  "width"=>"10px")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/daftar_tabel_json/json";
