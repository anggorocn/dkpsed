...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "TOTAL_MAHASISWA_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/total_mahasiswa_json/json";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/total_mahasiswa_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/total_mahasiswa_add?reqId="+vpilihid;
