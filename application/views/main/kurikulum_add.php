...
{
	$set= new Kurikulum();
	$set->selectByParams(array('KURIKULUM_ID'=>$reqId,'KURIKULUM_ID_PARENT'=>$reqParent));
	// echo $set->query;exit;
	$set->firstRow();
	        ...
	        <div class="card card-custom">
	        	...
	        	<div class="card-body">
		        	...
		        	<?if($reqParent!='' && $reqParent!='0'){?>
	        			<div class="form-group row">
		        			<label class="col-form-label col-lg-2 col-sm-12">SKS</label>	
		        			<div class="col-lg-8 col-sm-12">
		        				<input type="text" name="reqSks" class="form-control" value='<?=$reqSks?>'>
		        			</div>
		        		</div>
		        		<div class="form-group row">
		        			<label class="col-form-label col-lg-2 col-sm-12">Kode</label>	
		        			<div class="col-lg-8 col-sm-12">
		        				<input type="text" name="reqKode" class="form-control" value='<?=$reqKode?>'>
		        			</div>
		        		</div>
		        		<div class="form-group row">
		        			<label class="col-form-label col-lg-2 col-sm-12">Keterangan</label>	
		        			<div class="col-lg-8 col-sm-12">
		        				<select name="reqKeterangan" class="form-control">
		        					<option value="umum" <?if($reqKeterangan=='umum'){echo "selected";}?>>Umum</option>
		        					<option value="pilihan" <?if($reqKeterangan=='pilihan'){echo "selected";}?>>Pilihan</option>
		        				</select>
		        			</div>
		        		</div>
		        	<?}?>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/kurikulum_json/add";
