...
if(!empty($reqId))
{
    ...
    $set->selectByParams(array('TOTAL_MAHASISWA_ID'=>$reqId));
    // echo $set->query;exit;
    $set->firstRow();
    $reqTahun= $set->getField('TAHUN');
    $reqSemester= $set->getField('SEMESTER');
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Total Mahasiswa</h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 col-sm-12">Semester</label>   
                        <div class="col-lg-8 col-sm-12">
                            <select name="reqSemester" class="form-control">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 col-sm-12">Total</label>   
                        <div class="col-lg-8 col-sm-12">
                            <input type="text" name="reqTotal" class="form-control" value='<?=$reqTotal?>'>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        var formSubmitUrl = "json-main/total_mahasiswa_json/add";
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        Swal.fire({
                            ...
                            document.location.href = "app/index/total_mahasiswa";
                        });
                    },
