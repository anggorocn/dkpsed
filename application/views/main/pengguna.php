...
$arrtabledata= array(
    ...
    , array("label"=>"User Login", "field"=> "USER_LOGIN", "display"=>"",  "width"=>"", "nowrap"=>"1")
    , array("label"=>"Nama ", "field"=> "nama", "display"=>"",  "width"=>"10px")
    , array("label"=>"Group", "field"=> "user_group_nama", "display"=>"",  "width"=>"10px")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Akun Pengguna</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/pengguna_json/json";
